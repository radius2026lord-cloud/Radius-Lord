    ...
    <label className={`block ${className}`}>
      ...
      <div className={`group relative origin-center transition-[transform,filter] duration-[620ms] ease-[cubic-bezier(.16,1,.3,1)] ${hasValue ? "scale-[1.018]" : "scale-100"}`}>
        ...
        <input
          ...
          className={`relative h-[44px] w-full origin-center rounded-[14px] border bg-white text-[#17386d] outline-none transition-[transform,border-color,box-shadow,background-color,font-size,padding] duration-[620ms] ease-[cubic-bezier(.16,1,.3,1)] placeholder:text-[11px] placeholder:text-slate-400 dark:bg-[#211a25] dark:text-[#f4f1f5] dark:placeholder:text-[#8f8894] ${hasValue ? "border-[#6aa8ff] shadow-[0_0_0_1px_rgba(20,121,255,.16),0_8px_24px_rgba(20,121,255,.10)] dark:border-[#6aa8ff]/80 dark:shadow-[0_0_0_1px_rgba(106,168,255,.12),0_8px_26px_rgba(20,121,255,.10)]" : "border-[#ccd9e7] hover:border-[#9eb6d0] focus:border-[#4c8dff]/90 focus:ring-3 focus:ring-[#1479ff]/10 dark:border-white/[.10] dark:hover:border-white/[.20] dark:focus:border-[#6aa8ff] dark:focus:ring-[#1479ff]/20"} ${inputPadding}`}
        />
        {suffix}
      </div>
