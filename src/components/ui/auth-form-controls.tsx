...
export function PrimaryFormButton({ children, status, disabled = false }: { children: ReactNode; status?: PrimaryButtonStatus; disabled?: boolean }) {
  ...
  return <>
    ...
    {controlled && effectiveStatus === "success" && (
      <div className="auth-success-overlay fixed inset-0 z-[9999] flex h-[100dvh] w-[100vw] items-center justify-center bg-[#dce5ef]/30 backdrop-blur-[14px] dark:bg-[#1d1721]/35" aria-live="polite" aria-label="تم تسجيل الدخول بنجاح">
